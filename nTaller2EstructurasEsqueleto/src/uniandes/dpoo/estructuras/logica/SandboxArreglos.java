...
public class SandboxArreglos
{
    ...
    public void eliminarEntero( int valor )
    {
        ...
        for (int i = 0; i < arregloEnteros.length; i++) {
            if (arregloEnteros[i] != valor) {
                arregloEnteros[newSize++] = arregloEnteros[i];
            }
        }
        int[] nuevoArreglo = new int[newSize];
        System.arraycopy(arregloEnteros, 0, nuevoArreglo, 0, newSize);
        arregloEnteros = nuevoArreglo;
    }
    ...
    public void eliminarCadena( String cadena )
    {
        ...
        for (int i = 0; i < arregloCadenas.length; i++) {
            if (!arregloCadenas[i].equals(cadena)) {
                arregloCadenas[newSize++] = arregloCadenas[i];
            }
        }
        String[] nuevoArreglo = new String[newSize];
        System.arraycopy(arregloCadenas, 0, nuevoArreglo, 0, newSize);
        arregloCadenas = nuevoArreglo;
    }
    ...
    public int contarApariciones( String cadena )
    {
        ...
        for (String str : arregloCadenas) {
            if (str.toLowerCase().equals(lowerCaseCadena)) {
                count++;
            }
        }
        return count;
    ...
    public int[] calcularRangoEnteros( )
    {
        ...
        Arrays.sort(arregloEnteros);
        return new int[]{arregloEnteros[0], arregloEnteros[arregloEnteros.length - 1]};
    }
    ...
    public boolean mismosEnteros( int[] otroArreglo )
    {
        ...
        int[] copiaArreglo = getCopiaEnteros();
